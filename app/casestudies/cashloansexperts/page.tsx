    ...
    <main className="case-study">
      ...
      <article className="content">
        ...
        <figure className="screenshot-frame">
          <Image 
            src="/placeholder.png" 
            alt="Centralized partner data setup snippet"
            width={800}
            height={450}
            priority
          />
        ...
        {/* tal vez captura de un gbp haciendo highlight en el teléfono como único medio de identificación*/}
        <figure className="screenshot-frame">
          <Image 
            src="/placeholder.png" 
  ...
  halfpriceauto: {
    ...
    attribution: {
      ...
      utmMedium: "google"
        ...
        <div className="flow-diagram">
          <div className="node">User Visit</div>
          <div className="arrow">↓</div>
          <div className="node">Partner URL?</div>
          <div className="arrow">↓</div>
          <div className="node">Yes → Partner Attribution</div>
          <div className="arrow">↓</div>
          <div className="node">No</div>
          <div className="arrow">↓</div>
          <div className="node">UTM Present?</div>
          <div className="arrow">↓</div>
          <div className="node">Campaign Attribution</div>
          <div className="arrow">↓</div>
          <div className="node">Direct Traffic</div>
        </div>
        ...
        <section className="impact-grid">
          <div className="impact-card">
            <h4>90+ locations</h4>
            <p>Established a scalable framework capable of supporting 90+ partner locations.</p>
          </div>
          <div className="impact-card">
            <h4>5</h4>
            <p>Connected local Google Business Profiles with partner-specific landing experiences.</p>
          </div>
          <div className="impact-card">
            <h4>1</h4>
